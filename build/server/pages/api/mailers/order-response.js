...
const handler = (req, res)=>{
    const { to , templateData , response  } = req.body;
    ...
    integrations_sendgrid__WEBPACK_IMPORTED_MODULE_1__/* ["default"].send */ .Z.send(response ? approvedOrderEmail : deniedOrderEmail).catch((err)=>{
...
var __webpack_exports__ = __webpack_require__.X(0, [3407,4243], () => (__webpack_exec__(3106)));
