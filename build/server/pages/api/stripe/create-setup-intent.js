...
const handler = async (req, res)=>{
    const session = await (0,_blitzjs_auth__WEBPACK_IMPORTED_MODULE_1__.getSession)(req, res);
...
var __webpack_exports__ = __webpack_require__.X(0, [3407,4243], () => (__webpack_exec__(7335)));
