...
const __internal_rpcHandler = _blitzjs_rpc__WEBPACK_IMPORTED_MODULE_0__.resolver.pipe(_blitzjs_rpc__WEBPACK_IMPORTED_MODULE_0__.resolver.zod(_validations__WEBPACK_IMPORTED_MODULE_1__/* .CreateMenuItem */ .Bn), async (input, ctx)=>{
    const cartItem = {
        ...input
    };
    ...
    if (cartItems.length !== 0) {
        sum += cartItems.reduce((total, currentVal)=>{
...
__internal_rpcHandler._resolverName = "createMenuItemOnCart";
__internal_rpcHandler._resolverType = "mutation";
__internal_rpcHandler._routePath = "/api/rpc/createMenuItemOnCart";
