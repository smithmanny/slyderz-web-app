...
exports.Routes = {
  ...
  Account: (query) => ({ pathname: "/account", query }),
  BecomeAChef: (query) => ({ pathname: "/become-a-chef", query }),
  Checkout: (query) => ({ pathname: "/chefs/chef/[cid]/checkout", query }),
  ChefPage: (query) => ({ pathname: "/chefs/chef/[cid]", query }),
  Dashboard: (query) => ({ pathname: "/dashboard", query }),
  ForgotPasswordPage: (query) => ({ pathname: "/forgot-password", query }),
  Home: (query) => ({ pathname: "/", query }),
  LoginPage: (query) => ({ pathname: "/login", query }),
  ConfirmOrderPage: (query) => ({ pathname: "/orders/[oid]/confirm", query }),
  DenyOrderPage: (query) => ({ pathname: "/orders/[oid]/deny", query }),
  ConfirmationPage: (query) => ({ pathname: "/orders/[oid]/new", query }),
  ResetPasswordPage: (query) => ({ pathname: "/reset-password", query }),
  SignupPage: (query) => ({ pathname: "/signup", query }),
  About: (query) => ({ pathname: "/terms-and-conditions", query })
}
...
var _normalizeTrailingSlash = __webpack_require__(1766);
...
var _hasBasePath = __webpack_require__(5351);
const basePath =  false || "";
...
var _trustedTypes = __webpack_require__(2948);
var _requestIdleCallback = __webpack_require__(2087);
...
var _interop_require_wildcard = (__webpack_require__(164)/* ["default"] */ .Z);
...
var _headManager = __webpack_require__(374);
var _requestIdleCallback = __webpack_require__(2087);
...
var _normalizeTrailingSlash = __webpack_require__(1766);
var _removeTrailingSlash = __webpack_require__(3297);
var _routeLoader = __webpack_require__(2515);
var _script = __webpack_require__(9782);
var _isError = _interop_require_wildcard(__webpack_require__(8331));
...
var _detectDomainLocale = __webpack_require__(2376);
var _parsePath = __webpack_require__(8854);
var _addLocale = __webpack_require__(3898);
var _removeLocale = __webpack_require__(7391);
var _removeBasePath = __webpack_require__(9394);
var _addBasePath = __webpack_require__(8364);
var _hasBasePath = __webpack_require__(5351);
...
const _debug = __webpack_require__(6974);
...
const router = __webpack_require__(1570);
