...
export default async function TermsAndConditionsPage() {
  return (
    <Container>
      ...
      <br />
      <p>
        Welcome to Slyderz, LLC. (“Company”, “we”, “our”, “us”)! As you have
        just clicked our Terms of Service, please pause, grab a cup of coffee
        and carefully read the following pages. It will take you approximately 5
        minutes.
      </p>
      <br />
      <p>
      ...
      <p>
        ...
        use of our web pages. Please read it here: https://slyderz.co/privacy.
      </p>
      <br />
      <p>
      ...
      <p>
        ...
        support@slyderz.co so we can try to find a solution. These Terms apply
      ...
      <p>
        ...
        output or input or impose any usage restrictions per hour, regardless of
        what was previously committed at the time of subscription. These changes
        will be made according to our model capacity to safeguard the interests
        of all users and to ensure uniform access to the service. We take this
        step to provide equal opportunity to every user and protect the quality
        of our service.
      </p>
      <br />
      <p>
      ...
      <p>
        ...
        process the payment for your subscription. You shall provide Slyderz,
      ...
      <br />
      <p>
        Should automatic billing fail to occur for any reason, Slyderz, LLC.
      ...
      <p>
        ...
        purchase of the Contract with the condition that your words usage is
        less than 5000 Premium quality or equivalent words for any plans.
      </p>
      <br />
      <ul>
        <li>
          <p>
            ...
            will be automatically charged to the customer&apos;s selected
            payment method.
          </p>
        </li>
        <li>
          <p>
            Cancellations: If a customer needs to cancel a booking, they can do
            so without any charge if the cancellation is made at least 48 hours
        ...
        <li>
          <p>
            Chef Unavailability: If a chef becomes unavailable after a booking
            has been accepted (due to illness, emergency, etc.), Slyderz will
            make every effort to arrange an alternate chef of the same caliber.
            If a suitable replacement cannot be found, the customer will receive
            a full refund.
          </p>
        </li>
        <li>
          <p>
            Quality Concerns: If a customer has any concerns about the quality
            of service provided by a chef, we encourage immediate contact with
        ...
        <li>
          <p>
            All refunds, if eligible, will be processed within 7-10 business
            days.
          </p>
        </li>
      </ul>
      ...
      <p>
        ...
        first try to resolve the dispute informally by contacting us at
