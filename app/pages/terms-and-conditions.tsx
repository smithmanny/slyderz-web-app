...
const About: BlitzPage = () => (
  <ConsumerContainer>
    ...
    <Typography paragraph>
      ...
      Do not continue to use Slyderz if you do not agree to take all of the
      terms and conditions stated on this page. Our Terms and Conditions were
    ...
    <Typography paragraph>
      We employ the use of cookies. By accessing Slyderz, you agreed to use
      cookies in agreement with the Slyderz LLC's Privacy Policy.
    </Typography>
    ...
    <Typography paragraph>
      Unless otherwise stated, Slyderz LLC and/or its licensors own the
      intellectual property rights for all material on Slyderz. All intellectual
      property rights are reserved. You may access this from Slyderz for your
    ...
    <Typography paragraph>
      ...
      opinions and information in certain areas of the website. Slyderz LLC does
      not filter, edit, publish or review Comments prior to their presence on
      the website. Comments do not reflect the views and opinions of Slyderz
      LLC,its agents and/or affiliates. Comments reflect the views and opinions
      of the person who post their views and opinions. To the extent permitted
      by applicable laws, Slyderz LLC shall not be liable for the Comments or
    ...
    <Typography paragraph>
      Slyderz LLC reserves the right to monitor all Comments and to remove any
    ...
    <Typography paragraph>
      You hereby grant Slyderz LLC a non-exclusive license to use, reproduce,
    ...
    <Typography paragraph>
      ...
      hyperlink compensates the absence of Slyderz LLC; and (d) the link is in
    ...
    <Typography paragraph>
      ...
      e-mail to Slyderz LLC. Please include your name, your organization name,
    ...
    <Typography paragraph>
      No use of Slyderz LLC's logo or other artwork will be allowed for linking
