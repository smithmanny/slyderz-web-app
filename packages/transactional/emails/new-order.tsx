...
export const EmailNewOrder = ({
	...
	<SlyderzEmailLayout
		style={container}
		previewText="Your order has been requested."
	>
		<Hr style={global.hr} />
		<Section style={message}>
			...
			<Text style={{ ...global.text, marginTop: 24 }}>
				We´ve placed an authorization hold and will charge your card when the
				chef approves your order. For payment details, please visit your Orders
				page on Slyderz.co.
			</Text>
		</Section>
		<Hr style={global.hr} />
