    ...
    <ConsumerContainer disableGutters>
        ...
        <Grid item xs>
          <Section className={classes.headerSection}>
            ...
            <img
              ...
              className={classes.personalChef}
            />
          </Section>
        </Grid>
      </Grid>
          ...
          <Grid item xs={12} md={4}>
            <div className={classes.howSlyderzWorksCard}>
              ...
              <span className={classes.howSlyderzWorksCardText}>
                ...
                <Typography variant="h6">
                  All Slyderz chefs have undergone extensive training and food
                  safety handling
                </Typography>
              </span>
            </div>
          ...
          <Grid item xs={12} md={4}>
            <div className={classes.howSlyderzWorksCard}>
              ...
              <span className={classes.howSlyderzWorksCardText}>
                ...
                <Typography variant="h6">
                  Order in advance so chefs can buy fresh ingredients
                </Typography>
              </span>
            </div>
          </Grid>
          <Grid item xs={12} md={4}>
            <div className={classes.howSlyderzWorksCard}>
              ...
              <span className={classes.howSlyderzWorksCardText}>
                ...
                <Typography variant="h6">
                  Affordable private chef at your home{" "}
                </Typography>
              </span>
            </div>
          </Grid>
        ...
        <Section>
          <Grid container>
            <Grid item xs={12} md={6}>
              <img
                srcSet="/food-safety.jpg"
                alt="Personal chef cooking"
                className={classes.foodSafetyPic}
              />
            </Grid>
            <Grid
              item
              xs={12}
              md={6}
              className={classes.foodSafetyContentContainer}
            >
              <Typography variant="h2" className={classes.foodSafety}>
                Food Safety
              </Typography>
              <Typography className={classes.foodSafetyContent} paragraph>
                We’re committed to ensuring that your food will always be safe
                to eat by requiring our chefs to cook only fresh meat purchased
                the day of their scheduled event.
                <br />
                <br />
                All of our chefs have undergone extensive food safety training,
                including COVID-19 specific precautions and are required to have
                an active food handlers card. Chefs are required to cook out of
                commercial kitchens or other legally permissible facilities.
              </Typography>
            </Grid>
          </Grid>
        </Section>
          ...
          <BasicForm>
            <Paper
              ...
              className={classNames(
                classes.addressPaper,
                classes.addressPaperFooter
              )}
            >
              <TextField
                name="address"
      ...
      <Section className={classes.becomeAChefContainer}>
        <Grid container alignItems="center">
          <Grid item xs={12} md>
            <Typography variant="h3" className={classes.becomeAChef}>
              Become a Chef.
            </Typography>
          </Grid>
          <Grid item xs={12} md>
            <Typography className={classes.becomeAChefSubText} paragraph>
              Launching your private chef career has never been easier
            </Typography>
          </Grid>
