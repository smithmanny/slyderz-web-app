...
ADD COLUMN     "mondayStartTime" TIME(3),
DROP COLUMN "mondayEndTime",
ADD COLUMN     "mondayEndTime" TIME(3),
DROP COLUMN "tuesdayStartTime",
ADD COLUMN     "tuesdayStartTime" TIME(3),
DROP COLUMN "tuesdayEndTime",
ADD COLUMN     "tuesdayEndTime" TIME(3),
DROP COLUMN "wednesdayStartTime",
ADD COLUMN     "wednesdayStartTime" TIME(3),
DROP COLUMN "wednesdayEndTime",
ADD COLUMN     "wednesdayEndTime" TIME(3),
DROP COLUMN "thursdayStartTime",
ADD COLUMN     "thursdayStartTime" TIME(3),
DROP COLUMN "thursdayEndTime",
ADD COLUMN     "thursdayEndTime" TIME(3),
DROP COLUMN "fridayStartTime",
ADD COLUMN     "fridayStartTime" TIME(3),
DROP COLUMN "fridayEndTime",
ADD COLUMN     "fridayEndTime" TIME(3),
DROP COLUMN "saturdayStartTime",
ADD COLUMN     "saturdayStartTime" TIME(3),
DROP COLUMN "saturdayEndTime",
ADD COLUMN     "saturdayEndTime" TIME(3),
DROP COLUMN "sundayStartTime",
ADD COLUMN     "sundayStartTime" TIME(3),
DROP COLUMN "sundayEndTime",
ADD COLUMN     "sundayEndTime" TIME(3);
