/*
  ...
  - The values [UPLOAD_PROFILE_PHOTO] on the enum `OnboardingState` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "OnboardingState_new" AS ENUM ('SETUP_STRIPE', 'UPLOAD_HEADSHOT', 'COMPLETE_SERVSAFE', 'ADD_PROFILE_DESCRIPTION', 'DONE');
