import { getCookie as getSlyderzCookie, setCookie as setSlyderzCookie } from 'cookies-next';
...
export function setCookie(key: string, value: any, { req, res, ...options }: SetCookieOptionType) {
